...
class ComponentFragment: Fragment(R.layout.fragment_component), ProductsAdapter.OnItemClickListener {
        ...
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (currentSnapshot in snapshot.children) {
                    ...
                    if (currentProduct.productCategory == "PC ნაწილები") {
                        productList.add(currentProduct)
                    }
                }

                if (activity != null) {
                    recyclerViewProducts.adapter = ProductsAdapter(requireActivity(), productList, this@ComponentFragment)
                }
            }
