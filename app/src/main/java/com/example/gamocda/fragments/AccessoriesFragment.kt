...
class AccessoriesFragment: Fragment(R.layout.fragment_accessories), ProductsAdapter.OnItemClickListener {
        ...
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (currentSnapshot in snapshot.children) {
                    ...
                    if (currentProduct.productCategory == "PC აქსესუარები") {
                        productList.add(currentProduct)
                    }
                }

                if (activity != null) {
                    recyclerViewProducts.adapter = ProductsAdapter(requireActivity(), productList, this@AccessoriesFragment)
                }
            }
